                          ...
                          $('#ack_men').append(`<div class="col-lg-4 col-sm-12 col-xs-12">
                             <aside id="sidebar" class="left-bar" style="background:#dde1d0; padding-top:0px; box-shadow: 3px 3px 5px #292929;">
                                <div class="banner-sidebar " style="border-top-left-radius: 30px; border-top-right-radius: 30px;">
                                  ...
                                  <div class="col-lg-12 col-sm-12 col-xs-12" id="dashbdcount_${public_data}" style="background-image:url(http://192.168.0.6:8000/static/images/KM-bg.png)"></div>
                                    <table><tbody id="public_obj"><tr><td></td></tr></tbody>
                                          <tr><td><button onclick="megamyFunction('${response[i]['menu_name']}', '${response[i]['id']}')" class="thbg-color" style="background: #9f4545; background-color: #9f4545;
                                            border: none;
                                            color: white;
                                  ...
                                  <div class="col-lg-12 col-sm-12 col-xs-12" id="dashbdcount_${public_data}" style="background-image:url(http://192.168.0.6:8000/static/images/KM-bg.png)"></div>
                                    <table><tbody id="public_obj"><tr><td></td></tr></tbody>
                                          <tr><td><button class="thbg-color" style="background: #9f4545; background-color: #9f4545;
                                            ...
                                            border-radius:10px;
                                            cursor: pointer;" id="myBtn" onclick="megamyFunction('${response[i]['menu_name']}' , '${response[i]['id']}')">Read more</button></td></tr></table>
      ...
      data:{"menu":knowmenu},
       success: function(response){
         ...
         for (kk = 0; kk <response.data.length; kk ++ )
         {
           ...
           {
             $(policyId).append(`<div class="col-lg-12 col-sm-12 col-xs-12"  style="padding-top:3%; border-bottom:1px solid #8080802e"  ><div class="col-lg-2 col-sm-2 col-xs-2"><a href="http://192.168.0.6:8000${response.data[kk]['file']}" target='__blank'><i class="fa fa-file-pdf-o oranges" style="font-size:15px;color:#FF6347; border: 1px solid #ddd;
                                     border-radius: 4px;
                                     padding: 5px;
                                     width: auto; border-color: #f7b7c2; padding:10px; 10px  10px 10px"></i></a> </div><div class="col-lg-10 col-sm-10 col-xs-10" style="align:justify"><a href="http://192.168.0.6:8000${response.data[kk]['file']}" target="__blank" style=" color:#000; text-align: justify; overflow: hidden;
...

           {
            ...
            {
              $(policyId).append(`<div class="col-lg-12 col-sm-12 col-xs-12"  style="padding-top:3%; border-bottom:1px solid #8080802e; "  ><div class="col-lg-2 col-sm-2 col-xs-2"><a href="http://192.168.0.6:8000${response.data[kk]['file']}" target='__blank'><img src="http://192.168.0.6:8000${response.data[kk]['publication_file']}" width="40px"; height="37px" style="color:#FF6347;border-radius: 100%; border: 1px solid #ddd;
                border-radius: 100%;
                padding: 5px;
                width: auto; border-color: #f7b7c2; " ></a> </div>
                                      <div class="col-lg-10 col-sm-10 col-xs-10" style="align:justify"><a href="http://192.168.0.6:8000${response.data[kk]['file']}" target="__blank" style=" color:#000; text-align: justify; overflow: hidden;
                  text-overflow: ellipsis;
                  display: -webkit-box;
                  -webkit-line-clamp: 1; /* number of lines to show */
                  -webkit-box-orient: vertical;">${response.data[kk]['submenu_name']}</a></div></div>`)
